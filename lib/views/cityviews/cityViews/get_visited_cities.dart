...
class GetvisitedCity extends StatefulWidget {
  const GetvisitedCity({super.key});

  @override
  State<GetvisitedCity> createState() => _GetvisitedCity();
}

class _GetvisitedCity extends State<GetvisitedCity> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Get Visited Cities'),
        centerTitle: true,
      ),
      body: StreamProvider<List<CityModel>>.value(
        value: CityService().getVisitedCity(),
